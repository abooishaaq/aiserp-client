        ...
        {students
          .filter((student) => {
            return search
              .map((s) => {
                if (
                  student.profile.name.toLowerCase().includes(s.toLowerCase())
                ) {
                  return true;
                }

                if (
                  student.profile.users.filter(({ email }: { email: string }) =>
                ...
                const simplifiedGrade = simplifyGrade(student.class.grade);
                ...
                if (grade) {
                  return (
                    student.class.grade === grade || simplifiedGrade === grade
                  );
                }
                ...
                return s === student.class.section || s === simplifiedGrade;
              })
              .reduce((a, b) => a && b, true);
          })
          .map((student) => {
